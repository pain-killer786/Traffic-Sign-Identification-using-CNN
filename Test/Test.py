...
pickle_in = open("model_trained.p","rb")  ## rb = read bytes
...
def preprocessing(img):
    ...
    img = equalize(img)  # CONTRAST ENHANCEMENT (OPTIONAL)
...
while True:
    ...
    if probVal > threshold:
        ...
        cv2.putText(imgOrignal, str(round(probVal*100, 2)) + "%", (180, 75), font, 0.75, (0,0,255), 2, cv2.LINE_AA)
    
    # DISPLAY IMAGE
    cv2.imshow("Original Image", imgOrignal)
